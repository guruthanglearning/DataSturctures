...
namespace WindowsFormsApplication3
{
    public partial class StringsManipulation : Form
    {
        ...
        private void btn_Interleaving_String_Click(object sender, EventArgs e)
        {
            ...
            inputs.Add(new string[] { "aa", "ab", "aaba" });
        ...
        private void btn_Add_Strings_Click(object sender, EventArgs e)
        {
            ...
            StringBuilder result = new StringBuilder();
            List<Common> inputs = new List<Common>();
            inputs.Add(new Common() { Temp1 = "11", Temp2 = "123" });
            inputs.Add(new Common() { Temp1 = "456", Temp2 = "77" });
            inputs.Add(new Common() { Temp1 = "0", Temp2 = "0" });

            foreach (var input in inputs)
                result.AppendLine($"Add Strings for the given strings {input.Temp1} and {input.Temp2} is {AddStrings(input.Temp1, input.Temp2)}");
        ...
        public string AddStrings(string num1, string num2)
        {
            ...
            {
                sum = (n1Len >= 0 ? num1[n1Len] - '0' : 0) + (n2Len >= 0 ? num2[n2Len] - '0' : 0) + rem;
                rem = sum / 10;
                sum %= 10;
        ...
        private void btn_Substring_with_Concatenation_of_All_Words_Click(object sender, EventArgs e)
        {
            /*
            ...
            Tuple<string, string[]>[] inputs = new Tuple<string, string[]>[]
            {
                new Tuple<string, string[]>("barfoothefoobarman", new string[] { "foo", "bar" }),
                new Tuple<string, string[]>("wordgoodgoodgoodbestword", new string[] { "word", "good", "best", "word" }),
                new Tuple<string, string[]>("barfoofoobarthefoobarman", new string[] { "bar", "foo", "the" })
            };
            StringBuilder result = new StringBuilder();
        ...
        public IList<int> FindSubstring(string s, string[] words)
        {
            ...
            // Slide over the string with window of totalLength
